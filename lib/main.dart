...
import 'models/simpleBarChart.dart';

//enum scoreType { RIGHT, WRONG }
//enum animStates { COMPLETED, DISMISSED, FORWARD, REVERSE }
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Prediction Trainer',
      theme: ThemeData(
        primarySwatch: Colors.blue,
        visualDensity: VisualDensity.adaptivePlatformDensity,
      ),
      home: MyHomePage(title: 'Prediction Trainer'),
    );
  }
}
